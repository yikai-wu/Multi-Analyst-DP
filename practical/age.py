...
from src.workload_selection import work
...
W_name = np.array(['adult', 'age1', 'age2', 'age3', 'Total', 'Identity', 'Prefix'])
W_lst = np.array([census.__adult(), census.__age1(), census.__age2(), census.__age3(), workload.Total(n), workload.Identity(n), workload.Prefix(n)])

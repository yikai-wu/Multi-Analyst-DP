...
from src.bucket_filling import strategy_comp
...
res = error_calc(Ws, Wr, n, eps, modes, rep, As=As)
res_noW1 = error_calc(Ws[1:], Wr[1:], n, eps*(k-1)/k, modes, rep, As=As[1:])
for mode in modes[1:]:
    print(mode)
